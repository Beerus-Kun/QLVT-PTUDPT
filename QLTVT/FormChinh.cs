...
namespace QLTVT
{
    ...
    public partial class FormChinh : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        {
            RpDanhSachVatTu report = new RpDanhSachVatTu();
        ...
        {
            RpDonHangKhongPhieuNhap report = new RpDonHangKhongPhieuNhap();
            ReportPrintTool printTool = new ReportPrintTool(report);
            printTool.ShowPreviewDialog();
        }
        ...
        {
            Form f = this.CheckExists(typeof(FormBaoCaoNhapXuat));
            if (f != null)
            {
                f.Activate();
            }
            ...
            {
                FormBaoCaoNhapXuat form = new FormBaoCaoNhapXuat();
                //form.MdiParent = this;
                form.Show();
            }
        }
        ...
        {
            Form f = this.CheckExists(typeof(FormLoaiHang));
            if (f != null)
            {
                f.Activate();
            }
            ...
            {
                FormLoaiHang form = new FormLoaiHang();
                form.MdiParent = this;
                form.Show();
            }
        }
        ...
        {
            Form f = this.CheckExists(typeof(FormNhaCungCap));
            if (f != null)
            {
                f.Activate();
            }
